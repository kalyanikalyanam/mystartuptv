...
class EditNewsPage1 extends React.Component{
  constructor(props){
    super(props);
    this.datatable = null;
    this.state={
...
<div className="row">
 ...
 <Link to='/Admin/AddNews'>Add News <i className="fa fa-plus-square edit_clr" aria-hidden="true"></i></Link></div>
       ...
       {this.state.News.length>0? this.state.News.map((items,index) => {
            ...
            return(
                  ...
                  <td>
                    ...
                    {/* <div className="col-md-6">   */}
                    <button className="form-control edit_btn" title="Edit"><Link to={`/Admin/EditNews/${items.editId}`}>
