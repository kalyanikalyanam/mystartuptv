...
class EditMP3 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      headline: "",
  ...
  handleUploadStart1 = () => this.setState({ isUploading: true, progress1: 0 });
  ...
  handleSubmit = (event) => {
    // console.log("dkhnfkdfj");
    event.preventDefault();
    if (this.validator.allValid()) {
      const { mp3Id } = this.props.match.params;

      let dbCon = firebase.database().ref(`/Mp3/${mp3Id}`);
      console.log(dbCon);
      dbCon
        .update({
                ...
                <form onSubmit={this.handleSubmit}>
                  <div className="form-group c_n_block">
                    ...
                    <div className="col-md-9">
                      <ReactQuill
                        ...
                        modules={EditMP3.modules}
                        formats={EditMP3.formats}
                        bounds={".app"}
                  ...
                  <div className="form-group c_n_block">
                    ...
                    <div className="col-md-9">
                      ...
                      {this.state.mp3.substring(0, 100)}
                      <FileUploader
                        accept={["audio/*"]}
                        name="avatar1"
                        className="text_fillwidth"
