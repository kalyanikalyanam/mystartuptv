...
class ContactUs extends React.Component{
  ...
  handleSubmit=(event)=>{
    ...
    ref.push({ 
      ...
      this.setState({name:'',phoneno:'',email:'',address:'',message:'',})
...
<div>
    ...
    <h1 className="pgheadertitle animated mt-0 fadeInLeft pull-left head-pad">Contact Us</h1>
    </div>
	</div>
	</section>
							...
							<div className="box1 contactform">
                                ...
                                <form onSubmit={this.handleSubmit}>
									<div className="form">
                                        ...
                                        <div className="col-md-6">
										<input className="form-control c_n_block square" type="text" name="name" placeholder="Name" value={this.state.name} onChange={this.handleChange}/>
                                        {this.validator.message("Name", this.state.name, "required")}
										</div>
                                       
                                      <div className="col-md-6" >
                                          <input className="form-control c_n_block square" type="text" name="phoneno" placeholder="Phone" value={this.state.phoneno} onChange={this.handleChange}/>
                                       ...
                                       <div className="col-md-12 gap">
                                        ...
                                        <div className="col-md-12 gap">
                                        <textarea className="form-control c_n_block square" name="address" rows="4" placeholder="Address" value={this.state.address} onChange={this.handleChange}></textarea>
										{this.validator.message("address", this.state.address, "required")}
                                        </div>
                                        <div className="col-md-12 gap">
                                        <textarea className="form-control c_n_block square" name="message" rows="7" placeholder="Message" value={this.state.message} onChange={this.handleChange}></textarea>
