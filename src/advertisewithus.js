...
class AdvertiseWithUs extends React.Component{
  ...
  handleSubmit=(event)=>{
    ...
    ref.push({ 
      ...
      this.setState({company_name:'',phoneno:'',email:'',})
...
<div>
    ...
    <h1 className="pgheadertitle animated mt-0 fadeInLeft pull-left head-pad">Advertise With Us</h1>
    </div>
	</div>
	</section>
							...
							<div className="box1 contactform">
                                ...
                                <form onSubmit={this.handleSubmit}>
									<div className="form">
                                        ...
                                        <div className="col-md-6">
										<input className="form-control c_n_block square" type="text" name="company_name" placeholder="Company Name" value={this.state.company_name} onChange={this.handleChange}/>
